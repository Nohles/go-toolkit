...
func (p AudioParser) Parse(ctx context.Context, asset asset.PublicationAsset, fetcher fetcher.Fetcher) (*pub.Builder, error) {
	...
	for _, link := range links {
		...
		if link.MediaType == nil || link.MediaType.Equal(&mediatype.Binary) {
			link.MediaType = audioMediaTypeForExtension(fext)
		}
	...
	// Sort in natural order so numbered tracks such as 2 and 10 play correctly.
...
var allowed_extensions_audio_extra = map[string]struct{}{
	"asx": {}, "bio": {}, "cue": {}, "epub": {}, "json": {}, "log": {},
	"m3u": {}, "m3u8": {}, "mobi": {}, "nfo": {}, "pdf": {}, "pla": {},
	"pls": {}, "rtf": {}, "smil": {}, "txt": {}, "vlc": {}, "wpl": {},
	"xspf": {}, "zpl": {},
}
...
func audioMediaTypeForExtension(ext string) *mediatype.MediaType {
	switch ext {
	case "aac":
	...
	case "m4a", "m4b", "mp4", "m4r", "m4p", "alac":
		return &mediatype.MP4
	case "mp3":
		return &mediatype.MPEGAudio
	case "ogg", "oga", "mogg":
